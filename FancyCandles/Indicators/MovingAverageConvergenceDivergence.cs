...
namespace FancyCandles.Indicators
{
    ...
    public sealed class MovingAverageConvergenceDivergence : OverlayIndicator
    {
        ...
        ///</remarks>
        public override string FullName { get { return $"Moving Average Convergence Divergence, a={Smoothing}"; } }
        //---------------------------------------------------------------------------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------
        private double CalcEMA1IndicatorValue(int candle_i)
        {
            if (candle_i == 0)
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------
        private double CalcEMA2IndicatorValue(int candle_i)
        {
            if (candle_i == 0)
                return CandlesSource[0].C;
        ...
        {
            double macd = CalcEMA1IndicatorValue(candle_i);
            return macd;
        }
        //---------------------------------------------------------------------------------------------------------------------------------------
